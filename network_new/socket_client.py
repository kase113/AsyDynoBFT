    ...
    def _connect_and_send_forever(self):
        ...
        while not self.stop.value:
            try:
                ...
                # if all(self.is_out_sock_connected[self.startpoint:self.end]):
        ...
        if self.DYNAMIC:
            ...
            # send_threads = [gevent.spawn(self._send, j) for j in range(self.startpoint, self.end)]
            ...
            try:
                ...
                try:
                    ...
                    if j == -1: # -1 means broadcast
                        ...
                        # for i in range(self.startpoint, self.ends):
